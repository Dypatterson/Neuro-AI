...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| masked_token | generalization | 64 | 0.3 | 0.101 | [0.054, 0.181] | 0.213 | 1.000 | 1.000 | 0.100 | -14.059 |
| masked_token | generalization | 64 | 1 | 0.101 | [0.054, 0.181] | 0.213 | 1.000 | 1.000 | 0.102 | -4.357 |
| masked_token | generalization | 64 | 3 | 0.101 | [0.054, 0.181] | 0.213 | 0.000 | 1.000 | 0.069 | -1.593 |
| masked_token | generalization | 64 | 10 | 0.034 | [0.012, 0.094] | 0.213 | 0.000 | 0.000 | 0.095 | -1.001 |
| masked_token | generalization | 64 | 30 | 0.034 | [0.012, 0.094] | 0.213 | 0.000 | 0.000 | 0.165 | -1.000 |
| masked_token | generalization | 256 | 0.3 | 0.056 | [0.024, 0.125] | 0.213 | 1.000 | 1.000 | 0.041 | -18.655 |
| masked_token | generalization | 256 | 1 | 0.056 | [0.024, 0.125] | 0.213 | 1.000 | 1.000 | 0.036 | -5.719 |
| masked_token | generalization | 256 | 3 | 0.056 | [0.024, 0.125] | 0.213 | 0.000 | 1.000 | 0.008 | -2.036 |
| masked_token | generalization | 256 | 10 | 0.011 | [0.002, 0.061] | 0.213 | 0.000 | 0.000 | 0.224 | -1.005 |
| masked_token | generalization | 256 | 30 | 0.000 | [0.000, 0.041] | 0.213 | 0.000 | 0.000 | 0.225 | -1.000 |
| masked_token | generalization | 1024 | 0.3 | 0.000 | [0.000, 0.041] | 0.213 | 0.000 | 1.000 | 0.003 | -23.272 |
| masked_token | generalization | 1024 | 1 | 0.000 | [0.000, 0.041] | 0.213 | 0.000 | 1.000 | 0.008 | -7.102 |
| masked_token | generalization | 1024 | 3 | 0.000 | [0.000, 0.041] | 0.213 | 0.000 | 1.000 | 0.004 | -2.497 |
| masked_token | generalization | 1024 | 10 | 0.011 | [0.002, 0.061] | 0.213 | 0.000 | 0.000 | 0.008 | -1.034 |
| masked_token | generalization | 1024 | 30 | 0.056 | [0.024, 0.125] | 0.213 | 0.000 | 0.000 | 0.163 | -1.000 |
| masked_token | memorization | 64 | 0.3 | 0.217 | [0.123, 0.356] | 0.304 | 1.000 | 1.000 | 0.100 | -14.059 |
| masked_token | memorization | 64 | 1 | 0.217 | [0.123, 0.356] | 0.304 | 1.000 | 1.000 | 0.102 | -4.357 |
| masked_token | memorization | 64 | 3 | 0.217 | [0.123, 0.356] | 0.304 | 0.000 | 1.000 | 0.069 | -1.593 |
| masked_token | memorization | 64 | 10 | 1.000 | [0.923, 1.000] | 0.304 | 0.000 | 0.000 | 0.278 | -1.001 |
| masked_token | memorization | 64 | 30 | 1.000 | [0.923, 1.000] | 0.304 | 0.000 | 0.000 | 0.278 | -1.000 |
| masked_token | memorization | 256 | 0.3 | 0.077 | [0.039, 0.144] | 0.173 | 1.000 | 1.000 | 0.041 | -18.655 |
| masked_token | memorization | 256 | 1 | 0.077 | [0.039, 0.144] | 0.173 | 1.000 | 1.000 | 0.036 | -5.719 |
| masked_token | memorization | 256 | 3 | 0.077 | [0.039, 0.144] | 0.173 | 0.000 | 1.000 | 0.008 | -2.036 |
| masked_token | memorization | 256 | 10 | 1.000 | [0.964, 1.000] | 0.173 | 0.000 | 0.000 | 0.282 | -1.003 |
| masked_token | memorization | 256 | 30 | 1.000 | [0.964, 1.000] | 0.173 | 0.000 | 0.000 | 0.283 | -1.000 |
| masked_token | memorization | 1024 | 0.3 | 0.000 | [0.000, 0.040] | 0.217 | 0.000 | 1.000 | 0.003 | -23.272 |
| masked_token | memorization | 1024 | 1 | 0.000 | [0.000, 0.040] | 0.217 | 0.000 | 1.000 | 0.008 | -7.102 |
| masked_token | memorization | 1024 | 3 | 0.000 | [0.000, 0.040] | 0.217 | 0.000 | 1.000 | 0.004 | -2.497 |
| masked_token | memorization | 1024 | 10 | 1.000 | [0.960, 1.000] | 0.217 | 0.000 | 0.000 | 0.277 | -1.010 |
| masked_token | memorization | 1024 | 30 | 1.000 | [0.960, 1.000] | 0.217 | 0.000 | 0.000 | 0.279 | -1.000 |

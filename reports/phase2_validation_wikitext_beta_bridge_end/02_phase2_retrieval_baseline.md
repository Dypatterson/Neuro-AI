...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| masked_token | generalization | 64 | 0.3 | 0.102 | [0.056, 0.178] | 0.122 | 1.000 | 1.000 | 0.161 | -14.059 |
| masked_token | generalization | 64 | 1 | 0.102 | [0.056, 0.178] | 0.122 | 1.000 | 1.000 | 0.175 | -4.357 |
| masked_token | generalization | 64 | 3 | 0.102 | [0.056, 0.178] | 0.122 | 0.000 | 1.000 | 0.237 | -1.593 |
| masked_token | generalization | 64 | 10 | 0.051 | [0.022, 0.114] | 0.122 | 0.000 | 0.000 | 0.257 | -1.001 |
| masked_token | generalization | 64 | 30 | 0.061 | [0.028, 0.127] | 0.122 | 0.000 | 0.000 | 0.249 | -1.000 |
| masked_token | generalization | 256 | 0.3 | 0.102 | [0.056, 0.178] | 0.122 | 1.000 | 1.000 | 0.039 | -18.655 |
| masked_token | generalization | 256 | 1 | 0.102 | [0.056, 0.178] | 0.122 | 1.000 | 1.000 | 0.031 | -5.719 |
| masked_token | generalization | 256 | 3 | 0.102 | [0.056, 0.178] | 0.122 | 0.000 | 1.000 | 0.003 | -2.036 |
| masked_token | generalization | 256 | 10 | 0.010 | [0.002, 0.056] | 0.122 | 0.000 | 0.000 | 0.078 | -1.005 |
| masked_token | generalization | 256 | 30 | 0.000 | [0.000, 0.038] | 0.122 | 0.000 | 0.000 | 0.191 | -1.000 |
| masked_token | generalization | 1024 | 0.3 | 0.102 | [0.056, 0.178] | 0.122 | 0.000 | 1.000 | 0.004 | -23.272 |
| masked_token | generalization | 1024 | 1 | 0.010 | [0.002, 0.056] | 0.122 | 0.000 | 1.000 | 0.000 | -7.102 |
| masked_token | generalization | 1024 | 3 | 0.010 | [0.002, 0.056] | 0.122 | 0.000 | 1.000 | 0.007 | -2.497 |
| masked_token | generalization | 1024 | 10 | 0.000 | [0.000, 0.038] | 0.122 | 0.000 | 0.000 | 0.010 | -1.034 |
| masked_token | generalization | 1024 | 30 | 0.020 | [0.006, 0.071] | 0.122 | 0.000 | 0.000 | 0.150 | -1.000 |
| masked_token | memorization | 64 | 0.3 | 0.182 | [0.102, 0.303] | 0.218 | 1.000 | 1.000 | 0.161 | -14.059 |
| masked_token | memorization | 64 | 1 | 0.182 | [0.102, 0.303] | 0.218 | 1.000 | 1.000 | 0.175 | -4.357 |
| masked_token | memorization | 64 | 3 | 0.182 | [0.102, 0.303] | 0.218 | 0.000 | 1.000 | 0.237 | -1.593 |
| masked_token | memorization | 64 | 10 | 1.000 | [0.935, 1.000] | 0.218 | 0.000 | 0.000 | 0.280 | -1.001 |
| masked_token | memorization | 64 | 30 | 1.000 | [0.935, 1.000] | 0.218 | 0.000 | 0.000 | 0.280 | -1.000 |
| masked_token | memorization | 256 | 0.3 | 0.096 | [0.050, 0.179] | 0.193 | 1.000 | 1.000 | 0.039 | -18.655 |
| masked_token | memorization | 256 | 1 | 0.096 | [0.050, 0.179] | 0.193 | 1.000 | 1.000 | 0.031 | -5.719 |
| masked_token | memorization | 256 | 3 | 0.096 | [0.050, 0.179] | 0.193 | 0.000 | 1.000 | 0.003 | -2.036 |
| masked_token | memorization | 256 | 10 | 1.000 | [0.956, 1.000] | 0.193 | 0.000 | 0.000 | 0.278 | -1.002 |
| masked_token | memorization | 256 | 30 | 1.000 | [0.956, 1.000] | 0.193 | 0.000 | 0.000 | 0.278 | -1.000 |
| masked_token | memorization | 1024 | 0.3 | 0.057 | [0.025, 0.126] | 0.136 | 0.000 | 1.000 | 0.004 | -23.272 |
| masked_token | memorization | 1024 | 1 | 0.000 | [0.000, 0.042] | 0.136 | 0.000 | 1.000 | 0.000 | -7.102 |
| masked_token | memorization | 1024 | 3 | 0.000 | [0.000, 0.042] | 0.136 | 0.000 | 1.000 | 0.007 | -2.497 |
| masked_token | memorization | 1024 | 10 | 1.000 | [0.958, 1.000] | 0.136 | 0.000 | 0.000 | 0.276 | -1.010 |
| masked_token | memorization | 1024 | 30 | 1.000 | [0.958, 1.000] | 0.136 | 0.000 | 0.000 | 0.278 | -1.000 |
...
|---|---:|---:|---:|---:|---:|
| masked_token | 64 | 3 | 0.102 | 0.122 | 0.237 |

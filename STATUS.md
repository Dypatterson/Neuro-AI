...
- **Active blockers:**
  1. Phase 5 path decision still open: close Path C → choose between Path B' (close + pivot to surprise/PE-driven replay) and Path A (capacity-proportional scale-down probe as closure-paper evidence). No commitment in-session without user.
